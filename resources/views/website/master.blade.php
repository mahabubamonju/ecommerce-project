                            ...
                            <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="{{ route('blog-category') }}">Blog</a></li>
                                        <li><a href="{{ route('blog-detail', ['id' => 1]) }}">Blog Single</a></li>
                                ...
                                <li><a href="{{ route('home') }}">Business</a></li>
                                <li><a href="{{ route('home') }}">Politics</a></li>
                            </ul>
                        </div>
